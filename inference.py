...
# 1. First, verify CUDA is available
...
def get_model_output_with_rag(question, context):
    prompt = f"""Odgovori na naslednje vprašanje: "{question}". Lahko si pomagaš z kontekstom: "{question}"."""
...
def get_model_output_without_rag(question):
    ...
    outputs = model.generate(
        ...
        eos_token_id=tokenizer.eos_token_id,  # Use explicit EOS token
    )
